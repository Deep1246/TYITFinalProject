...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"><span class="nav_logo-name">Welcome , <br><%= user1.getName() %></span> </a>
                ...
                <div class="nav_list">
                 ...
                 <a href="javascript:showDiv1()" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span class="nav_name">Dashboard</span> </a> 
                 
                <a href="javascript:showDiv()" class="nav_link" > <i class='bx bx-user nav_icon'></i>Personal detail <span class="nav_name">
                 ...
                 <a href="javascript:showDiv2()" class="nav_link"> <i class='bx bx-bookmark nav_icon'></i> <span class="nav_name">Change Password</span> </a> 
                 
                 </div>
            </div> <a href="LogoutServlet" class="nav_link"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">SignOut</span> </a>
        </nav>
    </div>
    ...
    <div id="changepsk" style="display:none; margin-top: 5%" >
