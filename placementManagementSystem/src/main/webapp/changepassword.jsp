...
%>
	...
	<div class="card" style="width:70%; height:80%; margin-left: 17%;">
		<div class="card-body">
			...
			<form  action="PasswordOperationservlet" method="post" onclick="return validateForm()">
				
				<img src="Images/password.png" height="70px" width="70px"  style="margin-top: -12px; margin-left:40%; border-radius: 27px;">
